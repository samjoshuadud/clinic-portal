...
app.post('https://clinic-portal.onrender.com/patients', upload.single('image'), (req, res) => {
  const {
...
app.get('https://clinic-portal.onrender.com/patients', (req, res) => {
...
app.get('https://clinic-portal.onrender.com/patients/:id', (req, res) => {
  const { id } = req.params;
  const query = `
...
app.put('https://clinic-portal.onrender.com/patients/:id', (req, res) => {
  const { id } = req.params;
...
app.delete('https://clinic-portal.onrender.com/patients/:id', (req, res) => {
  const { id } = req.params;
...
app.get('https://clinic-portal.onrender.com/appointments', (req, res) => {
...
app.post('https://clinic-portal.onrender.com/appointments', (req, res) => {
...
app.delete('https://clinic-portal.onrender.com/appointments/:id', (req, res) => {
